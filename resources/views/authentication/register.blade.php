...
>
  <head>
    ...
    <title>Admin Register Basic - Oculin Tech BD Ltd.</title>
    ...
    <div class="container-xxl">
        <div class="authentication-wrapper authentication-basic container-p-y">
            ...
            <div class="card">
              ...
              <!-- /Logo -->
              <h4 class="mb-2" style="text-align: center;">Adventure starts here 🚀</h4>
              <p class="mb-4" style="text-align: center;">Make your app management easy and fun!</p>
            ...
            @endif
            <form id="formAuthentication" class="mb-3" action="{{ route('authRegister') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" autocomplete="off"/>
            ...
            <div class="mb-3">
                <label for="exampleFormControlSelect1" class="form-label">Admin Type</label>
                <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example" name="admin_type">
